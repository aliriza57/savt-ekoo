...
exports.run = async function(client, message, args) {
  ...
  .setColor("#00ff88")
  .setFooter(`SAVT| İstek Sistemi.`, client.user.avatarURL)
  const cfx2 = new Discord.RichEmbed()
  .setDescription(`\`${user.tag}\` Lütfen isteğinizi belirtin.`)
  .setColor("#ff0000")
  .setFooter(`1istek (isteğiniz)`, client.user.avatarURL)
...
.addField("Kullanıcı Rol",message.guild.member(message.author).highestRole.name,true)
.addField(`:thumbsup: `, 15,true)
.addField("İstek", code)
